    ...
    if (fav == false) {
        ...
        for (var i = 0; i < localStorage.length; i++) {
            ...
            if (localStorage.key(i).indexOf("_fav") > -1) {
                ...
                midhtml = midhtml + "<tr id=\"trow_" + ID + "\" class=\"un_sel\" onclick=\"polyF(" + ID + ",'" + ftype + "')\" style=\"height:50px\"><td><div style=\"text-overflow:ellipsis;white-space:nowrap;overflow:hidden;padding-left:3px;width:" + nameW + "px\">" + name + " " + ID + " " + ftype + "</div>" +
